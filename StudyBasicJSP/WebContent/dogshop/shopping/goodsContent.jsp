...
ShopgoodsDataBean goodsList = null;
String goods_kindName="";
ShopgoodsDBBean goodsProcess = ShopgoodsDBBean.getInstance();
...
<table width="800">
	...
	<b><%=goodsList.getgoods_title() %></b></font></td></tr>
	<tr><td width="500">저자 : <%=goodsList.getAuthor() %></td></tr>
	<tr><td width="500">출판사 : <%=goodsList.getPublishing_com() %></td></tr>
	<tr><td width="500">출판일 : <%=goodsList.getPublishing_date() %></td></tr>
	...
	<%
		...
		<input type="hidden" name="goods_title" value="<%=goodsList.getgoods_title()%>">
