...
if(count>0){
	...
	if(startPage>10) {%>
	<font ><a href="list.jsp?pageNum=<%=startPage-10 %>">[이전]</a></font>
<% }
	
	for(int i=startPage; i<=endPage; i++){ 
		if(i==currentPage){%>
		<font size="+1"><a href="list.jsp?pageNum=<%=i %>">[<%=i %>]</a></font>
		<%}else { %>
		<a href="list.jsp?pageNum=<%=i %>">[<%=i %>]</a>
		<%}
		}
	if(endPage < pageCount){%>
	<font ><a href="list.jsp?pageNum=<%=startPage+10 %>">[다음]</a></font>
<%}
}
%>
<br>
<font size="-1">현제페이지 : <%=currentPage %></font>
<br>
<img alt="멈무" src="../images/aaa.png" align="right"width="100" class="img">
</body>
</html>